...
public class HuffmanDecompress {
	 ...
	 * freing the memory
	 *********************************************************************************/
	public static void initHuffmanDecompress() {
		int i;
		if (Root != null)
			fredfs1(Root);
		for (i = 0; i < 300; i++)
	 ...
	 * unzipping function
	 **************************************************************************************/
	public static void readbin(String input, String output) {
	...
	public static void beginHuffmanDecompress(String input, String output) {
		initHuffmanDecompress();
		readfreq1(input);
		createbin();
		readbin(input, output);
		initHuffmanDecompress();
	}

	/*
	 * public static void main (String arg[]) { initHuffmanDecompress(); String
	 ...
	 * afterextracting readbin(arg1,arg2); initHuffmanDecompress(); }
	 */
}